		...
		<div class="row">
			<div class="col-12 web-location">
				<ul>
					...
					<li>
						<a href="#">ថ្នាក់បរិញ្ញាបត្ររង ឯកទេស នីតិសាស្រ </a>
					</li>
			...
			<div class="col-xxl-9">
				<div class="container" style="background-color:#002060;">
					<div class="row title-text">
						ថ្នាក់បរិញ្ញាបត្ររង ឯកទេស នីតិសាស្រ
					</div>
				</div>
				<div id="content-detail">
					<?php  
							$stmt= $conn->prepare("SELECT * from usea_article WHERE article_id =393");
							$stmt->execute();
                    ...
                    <div class="container">
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="tab-pane" id="pills-bms" role="tabpanel" aria-labelledby="pills-bms-tab" tabindex="0">
								<?php
									$stmt = $conn->prepare("SELECT * from usea_article WHERE article_id =410");
									$stmt->execute();
									$result = $stmt->fetchAll(PDO::FETCH_ASSOC);
									// echo "<pre>";
									// print_r($result);
							...
							<div class="tab-pane" id="pills-cex" role="tabpanel" aria-labelledby="pills-cex-tab" tabindex="0">
								<?php
									$stmt = $conn->prepare("SELECT * from usea_article WHERE article_id =412");
									$stmt->execute();
									$result = $stmt->fetchAll(PDO::FETCH_ASSOC);
									// echo "<pre>";
									// print_r($result);
