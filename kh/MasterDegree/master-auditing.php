		...
		<div class="row">
			<div class="col-12 web-location">
				<ul>
					...
					<li>
						<a href="#"> ថ្នាក់អនុបណ្ឌិត ជំនាញសវនកម្ម </a>
					</li>
		...
		<div class="row">
			...
			<div class="col-xxl-9">
				<div class="container" style="background-color:#002060;">
					...
					ថ្នាក់អនុបណ្ឌិត ជំនាញសវនកម្ម
					</div>
				</div>
				<div id="content-detail">
					<?php  
							$stmt= $conn->prepare("SELECT * from usea_article WHERE article_id =474");
							$stmt->execute();
						...
						<div class="container">
							...
							<div class="tab-content" id="pills-tabContent">
								<div class="tab-pane show active" id="pills-y1" role="tabpanel" aria-labelledby="pills-y1-tab" tabindex="0">
									<?php
										$stmt = $conn->prepare("SELECT * from usea_article WHERE article_id =475");
										$stmt->execute();
										$result = $stmt->fetchAll(PDO::FETCH_ASSOC);
										// echo "<pre>";
										// print_r($result);
								...
								<div class="tab-pane" id="pills-y2" role="tabpanel" aria-labelledby="pills-y2-tab" tabindex="0">
									<?php
										$stmt = $conn->prepare("SELECT * from usea_article WHERE article_id =476");
										$stmt->execute();
										$result = $stmt->fetchAll(PDO::FETCH_ASSOC);
										// echo "<pre>";
										// print_r($result);
