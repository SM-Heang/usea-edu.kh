				...
				<div class="row mt-3 mb-5 g-3" id="events">
					...
					foreach ($result as $key => $value) { ?>
						...
						<div class="card w-50 h-100 w-100 animate-card">
							...
							<div class="card-body">
								<h6 class="card-title title-f"><?php echo mb_strimwidth($value['event_title_kh'], 0 ,140, "..."); ?></h6>
								
							</div>
							<div class="card-footer text-end p-1">
								<a href="event-detail.php?id=<?php echo $value['event_id'] ?>" class="btn btn-sm event-btn text-end py-1 px-3">អានបន្ថែម</a>
							</div>
						</div>
					</div>
					<?php } ?>
