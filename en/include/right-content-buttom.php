<div class="col-xxl-3">
	<div class="right-content-economic">
		<div class="item"><a class="nav-link item-link <?php if ($_SESSION['right'] == 'human_resource') {
															echo 'right_active';
														} ?>" href="human-resource.php"> Human Resource </a></div>
		<hr>
		<div class="item">
			<nav class="sidebar">
				<ul class="nav flex-column" id="nav_accordion">
					<li class="nav-item has-submenu ">
						<a class="nav-link item-link" href="student-services.php" onclick="return false"> Student Services
							<i class="fa-solid fa-angle-down" onclick="changeIcon(this)"></i>
						</a>
						<ul class="submenu collapse <?php if ($_SESSION['page'] == 'practucum-internship') { echo "show"; } ?>">
							<li><a class="nav-link item-link <?php if ($_SESSION['right'] == 'practucum_internship') { echo 'right_active';} ?>" 
								   aria-current="page" href="practucum-internship.php"> Practucum/Internship </a></li>
		...
		<div class="item">
			<nav class="sidebar">
				<ul class="nav flex-column <?php if ($_SESSION['page'] == 'library') { echo "show"; } ?>" id="nav_accordion">
					<li class="nav-item has-submenu">
						<a class="nav-link item-link" href="#" onclick="return false"> Library
