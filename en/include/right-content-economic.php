						...
						">
							<li>
								<a class="nav-link item-link 
										<?php if ($_SESSION['page'] == 'bachelor-degree-management') {
																	echo 'right_active';
																} ?>" 
									href="../BachelorDegree/bachelor-degree-management.php"> Management
								 </a
								 ></li>

							<li>
								<a class="nav-link item-link 
										<?php if ($_SESSION['page'] == 'bachelor-degree-marketing') {
																	echo 'right_active';
																} ?>" 
									href="../BachelorDegree/bachelor-degree-marketing.php"> Marteting
								 </a
								 ></li>
							...
							<li>
								<a class="nav-link item-link 
									...
									href="../BachelorDegree/bachelor-degree-accounting-auditing.php"> Accounting & Auditing
								</a>
							 </li>

							<li>
								<a class="nav-link item-link 
										<?php if ($_SESSION['page'] == 'bachelor-degree-finance-banking') {
																	echo 'right_active';
																} ?>" 
									href="../BachelorDegree/bachelor-degree-finance-banking.php"> Finance and Banking 
								</a>
							 </li>

							<li>
								<a class="nav-link item-link 
										<?php if ($_SESSION['page'] == 'bachelor-degree-industrail-economics') {
																	echo 'right_active';
																} ?>" 
									href="../BachelorDegree/bachelor-degree-industrail-economics.php"> Industrail Economics 
								</a>
							 </li>

							<li>
								<a class="nav-link item-link 
										<?php if ($_SESSION['page'] == 'bachelor-international-economics') {
																	echo 'right_active';
																} ?>" 
							...
							<li>
								<a class="nav-link item-link 
										<?php if ($_SESSION['page'] == 'bachelor-intrepreneurship') {
																	echo 'right_active';
																} ?>" 
							...
							<li>
								<a class="nav-link item-link 
										<?php if ($_SESSION['page'] == 'bechelor-international-business') {
																	echo 'right_active';
																} ?>" 
									href="../BachelorDegree/bechelor-international-business.php"> International Business 
								</a>
							 </li>

							<li>
								<a class="nav-link item-link 
										<?php if ($_SESSION['page'] == 'bachelor-international-tourism-management') {
																	echo 'right_active';
																} ?>" 
									href="../BachelorDegree/bachelor-international-tourism-management.php"> International Tourism Management 
								</a>
							 </li>
							...
							<li>
								<a class="nav-link item-link 
									...
									href="../BachelorDegree/bechelor-catering-management.php"> Catering Management 
								</a>
							 </li>

							<li>
								<a class="nav-link item-link 
										<?php if ($_SESSION['page'] == 'bachelor-tourism-hospitality-management') {
																	echo 'right_active';
																} ?>" 
									href="../BachelorDegree/bachelor-tourism-hospitality-management.php"> Tourism and Hospitality Management 
								</a>
							 </li>
