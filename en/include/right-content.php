				...
				<div class="right-content">
					<ul>
						...
						<li>
							...
							<ul>
								<li><a href="upcoming-events.php" class="<?php if($page== 'upcoming'){echo 'active';}?>">Upcoming Events</a><br><hr></li>
								<li><a href="events.php" class="<?php if($page== 'events'){echo 'active';}?>">Past Events</a><br><hr></li>
							</ul>
						</li><br><hr>
						<li><a href="location.php" class="<?php if($page== 'location'){echo 'active';}?>">Location</a></li><br><hr>
					</ul>
				</div>
			</div>
		</div>
