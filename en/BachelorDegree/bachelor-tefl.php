		...
		<div class="row">
			<div class="col-12 web-location">
				<ul>
					...
					<li>
					<a href="#"> Teaching English as Foreign Language </a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xxl-9">
				<div class="container title-bg">
					...
					Bachelor's Degree in Teaching English as Foreign Language
					</div>
				</div>
				<div id="content-detail">
				<?php  
							$stmt= $conn->prepare("SELECT * from usea_article WHERE article_id =466");
							$stmt->execute();
					...
					<section>
						<div class="container">
							<div class="nav-header justify-content-center align-items-center px-0 px-lg-3">
