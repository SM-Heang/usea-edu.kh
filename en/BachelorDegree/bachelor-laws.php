                ...
                <section>
                    ...
                    <div class="container">
                        <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                            <button class="nav-link active" style="font-size: 18px; color: #002060;"
                                id="nav-foundation-tab" data-bs-toggle="tab" data-bs-target="#nav-foundation"
                                type="button" role="tab" aria-controls="nav-foundation" aria-selected="true">
                                General Education Subject
                            </button>
                            <button class="nav-link" style="font-size: 18px; color: #002060;" id="nav-second-tab"
                                data-bs-toggle="tab" data-bs-target="#nav-second" type="button" role="tab"
                                aria-controls="nav-second" aria-selected="false">
                                Core Major Subjects
                            </button>
                            <button class="nav-link" style="font-size: 18px; color: #002060;" id="nav-third-tab"
                                data-bs-toggle="tab" data-bs-target="#nav-third" type="button" role="tab"
                                aria-controls="nav-third" aria-selected="false">
                                Basic Major Subjects
                            </button>
                            <button class="nav-link" style="font-size: 18px; color: #002060;" id="nav-forth-tab"
                                data-bs-toggle="tab" data-bs-target="#nav-forth" type="button" role="tab"
                                aria-controls="nav-forth" aria-selected="false">
                                Minor Subjects
                            </button>
                        </div>
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active p-3" id="nav-foundation" role="tabpane1"
                                aria-labelledby="nav-foundation-tab">
                                <p>
                                    <?php
										echo $value['article_description_en'];
										?>
                            ...
                            <div class="tab-pane fade active p-3" id="nav-second" role="tabpane1"
                            ...
                            <div class="tab-pane fade active p-3" id="nav-third" role="tabpane1"
                            ...
                            <div class="tab-pane fade active p-3" id="nav-forth" role="tabpane1"
                                aria-labelledby="nav-forth-tab">
                                <table class="table">
                                    <thead style="font-size: 18px; color: #002060;">
                                        <th>No</th>
                                        <th>Subject Description</th>
